            ...
            <div class="row g-4 justify-content-center">
                    ...
                    <a href="#">
                        <div class="course-item bg-light h-100 d-flex flex-column">
                            <div class="position-relative overflow-hidden">
                                <img class="img-fluid image-fixed-size-cus" src="/mainasset/img/course-1.jpg"
                                    alt="">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <a href="#">
                        <div class="course-item bg-light h-100 d-flex flex-column">
                            <div class="position-relative overflow-hidden">
                                <img class="img-fluid image-fixed-size-cus" src="/mainasset/img/course-2.jpg"
                                    alt="">
                                {{-- <div class="w-100 d-flex justify-content-center position-absolute bottom-0 start-0 mb-4">
                                    <a href="#" class="flex-shrink-0 btn btn-sm btn-primary px-3 border-end"
                                        style="border-radius: 30px 0 0 30px;">Read More</a>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <a href="#">
                        <div class="course-item bg-light h-100 d-flex flex-column">
                            <div class="position-relative overflow-hidden">
                                <img class="img-fluid image-fixed-size-cus" src="/mainasset/img/course-3.jpg"
                                    alt="">
                                {{-- <div class="w-100 d-flex justify-content-center position-absolute bottom-0 start-0 mb-4">
                                    <a href="#" class="flex-shrink-0 btn btn-sm btn-primary px-3 border-end"
                                        style="border-radius: 30px 0 0 30px;">Read More</a>
