<aside class="left-sidebar sidebar-light" id="left-sidebar">
    <div id="sidebar" class="sidebar sidebar-with-footer">
        ...
        <div class="app-brand">
            <a href="{{ route('admin') }}">
                <img src="/adminasset/images/logo.png" alt="Mono">
        ...
        <div class="sidebar-left" data-simplebar style="height: 100%;">
            ...
            <ul class="nav sidebar-inner" id="sidebar-menu">
                ...
                <li class="{{ request()->is('admin/dashboard') || request()->is('admin') ? 'active' : 'has-sub' }}">
                ...
                <li class="has-sub">
                    <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#email"
                        ...
                        <span class="nav-text">Role</span> <b class="caret"></b>
                    </a>
                ...
                <li
                    ...
                    <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse"
                        ...
                        <span class="nav-text">Diklat</span> <b class="caret"></b>
                    </a>
                    <ul class="collapse" id="authentication" data-parent="#sidebar-menu">
                        <div class="sub-menu">
                            <li>
                                <a class="sidenav-item-link" href="{{ route('admin.diklat.daftar') }}">
                            ...
                            <li>
                                <a class="sidenav-item-link" href="{{ route('admin.diklat') }}">
